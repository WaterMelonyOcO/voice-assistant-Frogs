        ...
        <>
            <div className="firstLine">
                <span className='place'>
                    <img src={placeIcon} alt="иконка места" />
                    <p>Краснодар</p>
                </span>
                <span className='btn-layout'>
                    <button className='btn_header btn-lang' title="Cмена языка">
                        <img src={worldIcon} alt="смена языка"/> Русский
                    </button>
                    <button className='btn_header btn-acc' onClick={() => setModalActive(true)} title="Кнопка редактирования страницы со спец. возможностями">
                        <img src={pepIcon} alt="спец.возможности"/> Спец.возможности
                    </button>
                    <button className='btn_header btn-help' title="Кнопка открытия голосового помощника" onClick={() => setModalVoiceAssistantActive(true)}>
                        <img src={saverIcon} alt="голосовой помощник"/>Голосовой помощник
                    </button>
                </span>
            ...
            <header className='header'>
                <span className='header-one_block'>
                    <Link to='/main'>
                        <img src={logo} alt="нажмите сюда для перехода на главную страницу" title="Нажмите сюда для перехода на главную страницу"/>
                    </Link>
                    <InputSearch />
                </span>
